    ...
    public void runUi() {
        try {
            ...
            case 1:   //Account Balance Enquiry
            			Mobile w1 = new Mobile("9440726827","Sekhar", 700);
                          Mobile  w2=new Mobile("9441607400","Sailaja",100);
            ...
            case 2:   //Recharge Account
            			Mobile wp = new Mobile("9440726827","Sekhar", 700);
                           Mobile  wq=new Mobile("9441607400","Sailaja",100);
            	           service.addMobile(wp);
                            service.addMobile(wq);
                           System.out.println("Enter the mobile number:");
